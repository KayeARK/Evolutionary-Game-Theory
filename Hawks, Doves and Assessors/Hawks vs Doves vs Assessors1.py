...
dovepopulation.append(population.count(0))
assessorpopulation.append(population.count(2))
assessorpopulation[-1]/(assessorpopulation[-1]+hawkpopulation[-1]+dovepopulation[-1])   


plt.plot(timearray,hawkpopulation, label="Hawks", c='r')
plt.plot(timearray,dovepopulation, label="Doves", c='g')
plt.plot(timearray,assessorpopulation, label="Assessor", c='b')
plt.xlabel("Generation Number")
plt.ylabel("Number of Individuals")
plt.legend()

plt.rcParams['pdf.fonttype'] = 42
plt.savefig('LouiseMultiplayerHawksDovesAssessorsPureStrategyN3G3C0.pdf',bbox_inches='tight',transparent = True)
